...
def prediction(data, time) :
    ...
    obsv_df = obsv_df*df_std + df_mean

    choosechem(37.6,126.9,obsv_df.loc[time[0]:time[t-1]],pred_df.loc[time[0]:time[t-1]], 'PM25')
    choosechem(37.6,127.0, obsv_df.loc[time[0]:time[t-1]], pred_df.loc[time[0]:time[t-1]], 'PM25')
    choosechem(37.5,126.9, obsv_df.loc[time[0]:time[t-1]], pred_df.loc[time[0]:time[t-1]], 'PM25')
    choosechem(37.5, 127.0, obsv_df.loc[time[0]:time[t-1]], pred_df.loc[time[0]:time[t-1]], 'PM25')
    choosechem(37.5, 127.1, obsv_df.loc[time[0]:time[t-1]], pred_df.loc[time[0]:time[t-1]], 'PM25')
    choosechem(37.4, 126.9, obsv_df.loc[time[0]:time[t-1]], pred_df.loc[time[0]:time[t-1]], 'PM25')
    choosechem(37.4, 127.0, obsv_df.loc[time[0]:time[t-1]], pred_df.loc[time[0]:time[t-1]], 'PM25')
    choosechem(37.4, 127.1, obsv_df.loc[time[0]:time[t-1]], pred_df.loc[time[0]:time[t-1]], 'PM25')
